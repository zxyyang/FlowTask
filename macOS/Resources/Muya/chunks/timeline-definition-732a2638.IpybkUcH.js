import { aC as ft, y as gt, c as mt, l as E, h as G, r as xt, aD as _t, aE as bt, aF as kt } from "./mermaid.core.ZiMYvjlI.js";
import "./emojis.bYhmvyOg.js";
import { a as D } from "./arc.CIwEnYSO.js";
...
const Mt = function(n, t, e) {
  ...
  function t(s, h, o, p, y, f, _, m, g) {
    ...
    for (let d = 0; d < c.length; d++) {
      ...
      l.append("tspan").attr("x", o + y / 2).attr("dy", u).text(c[d]), l.attr("y", p + f / 2).attr("dominant-baseline", "central").attr("alignment-baseline", "central"), a(l, _);
    }
  }
  function e(s, h, o, p, y, f, _, m) {
    ...
    r.append("div").attr("class", "label").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(s), t(s, g, o, p, y, f, _, m), a(r, _);
  }
  function a(s, h) {
    for (const o in h)
      o in h && s.attr(o, h[o]);
...
function yt(n, t) {
  n.each(function() {
    ...
    for (let _ = 0; _ < a.length; _++)
      s = a[a.length - 1 - _], h.push(s), f.text(h.join(" ").trim()), (f.node().getComputedTextLength() > t || s === "<br>") && (h.pop(), f.text(h.join(" ").trim()), s === "<br>" ? h = [""] : h = [s], f = e.append("tspan").attr("x", 0).attr("y", p).attr("dy", o + "em").text(s));
  });
}
const Ht = function(n, t, e, a) {
  ...
  const o = h.append("g"), p = h.append("g"), f = p.append("text").text(t.descr).attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle").call(yt, t.width).node().getBBox(), _ = a.fontSize && a.fontSize.replace ? a.fontSize.replace("px", "") : a.fontSize;
  return t.height = f.height + _ * 1.1 * 0.5 + t.padding, t.height = Math.max(t.height, t.maxHeight), t.width = t.width + 2 * t.padding, p.attr("transform", "translate(" + t.width / 2 + ", " + t.padding / 2 + ")"), zt(o, t, s), t;
}, Ct = function(n, t, e) {
...
}, nt = function(n, t, e, a, s, h, o, p, y, f, _) {
  var m;
  for (const g of t) {
    const i = {
      descr: g.task,
  ...
  for (const y of t) {
    ...
    E.debug("eventNode", f);
    const _ = n.append("g").attr("class", "eventWrapper"), g = H.drawNode(_, f, e, h).height;
    o = o + g, _.attr("transform", `translate(${a}, ${s})`), s = s + 10 + g;
  }
  return s = p, o;
}, Vt = {
  setConf: () => {
