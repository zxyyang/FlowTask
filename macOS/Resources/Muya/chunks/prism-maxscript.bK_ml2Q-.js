  ...
  t.languages.maxscript = {
    ...
    "function-call": {
      pattern: RegExp(
        ...
        /\b(?:and|by|case|catch|collect|do|else|if|in|not|or|return|then|to|try|where|while|with)\b/.source) + ")[ 	]*)(?!" + e.source + ")" + /[a-z_]\w*\b/.source + "(?=[ 	]*(?:" + // variable
        ("(?!" + e.source + ")" + /[a-z_]/.source + "|" + // number
