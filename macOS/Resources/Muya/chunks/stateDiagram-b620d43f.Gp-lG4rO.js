import { p as P, d as N, s as W } from "./styles-bbc3fe3b.FVM_kCAO.js";
import { c as t, h as H, l as b, i as R, j as T, x as v } from "./mermaid.core.ZiMYvjlI.js";
import { G as U, l as C } from "./layout.JVnYm5l-.js";
import "./emojis.bYhmvyOg.js";
import { l as F } from "./line.3WL5MWbk.js";
import { g as $ } from "./step.sPVUIIxm.js";
...
const K = function(e, i, o) {
  ...
  const s = i.points, g = F().x(function(r) {
    return r.x;
  }).y(function(r) {
    return r.y;
  }).curve($), p = e.append("path").attr("d", g(s)).attr("id", "edge" + G).attr("class", "transition");
  let a = "";
  if (t().state.arrowMarkerAbsolute && (a = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search, a = a.replace(/\(/g, "\\("), a = a.replace(/\)/g, "\\)")), p.attr(
    ...
    const r = e.append("g").attr("class", "stateLabel"), { x: y, y: x } = v.calcLabelPosition(i.points), d = T.getRows(o.title);
    let l = 0;
    const m = [];
    let w = 0, E = 0;
