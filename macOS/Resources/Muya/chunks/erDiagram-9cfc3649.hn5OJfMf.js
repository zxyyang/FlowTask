import { c as Z, s as Et, g as mt, b as gt, a as kt, u as xt, v as Rt, l as V, y as Ot, h as rt, x as bt, i as Nt, ap as Tt } from "./mermaid.core.ZiMYvjlI.js";
import { G as At, l as Mt } from "./layout.JVnYm5l-.js";
import "./emojis.bYhmvyOg.js";
import { l as St } from "./line.3WL5MWbk.js";
import { g as wt } from "./step.sPVUIIxm.js";
...
var at = function() {
  var t = function(S, a, n, c) {
    ...
    parse: function(a) {
      ...
      for (var w, z, v, tt, G = {}, j, P, lt, q; ; ) {
        if (z = c[c.length - 1], this.defaultActions[z] ? v = this.defaultActions[z] : ((w === null || typeof w > "u") && (w = _t()), v = K[z] && K[z][w]), typeof v > "u" || !v.length || !v[0]) {
          var et = "";
          q = [];
          for (j in K[z])
...
Expecting ` + q.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : et = "Parse error on line " + (Q + 1) + ": Unexpected " + (w == ot ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(et, {
        ...
        switch (v[0]) {
          case 1:
            c.push(w), E.push(b.yytext), i.push(b.yylloc), c.push(v[1]), w = null, st = b.yyleng, s = b.yytext, Q = b.yylineno, $ = b.yylloc;
            break;
          case 2:
            if (P = this.productions_[v[1]][1], G.$ = E[E.length - P], G._$ = {
              ...
              return tt;
            P && (c = c.slice(0, -1 * P * 2), E = E.slice(0, -1 * P), i = i.slice(0, -1 * P)), c.push(this.productions_[v[1]][0]), E.push(G.$), i.push(G._$), lt = K[c[c.length - 2]][c[c.length - 1]], c.push(lt);
            break;
          case 3:
            return !0;
        }
...
const ne = function(t, e, r, u, l) {
  ...
  const p = r.edge(
    ...
    return N.y;
  }).curve(wt), o = t.insert("path", "#" + u).classed("er relationshipLine", !0).attr("d", f(p.points)).style("stroke", k.stroke).style("fill", "none");
  ...
  Mt(h), ie(o, h), m.forEach(function(I) {
    ne(o, I, h, _, u);
  });
