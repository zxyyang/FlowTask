import { p as M, d as N, s as $ } from "./styles-4ba6ed67.0gwRoBtS.js";
import { l as d, c, h as w, x as R, r as B, q as E, o as G, j as _ } from "./mermaid.core.ZiMYvjlI.js";
import { G as q } from "./layout.JVnYm5l-.js";
import { r as z } from "./index-67a42d7d.61-agvfn.js";
import "./emojis.bYhmvyOg.js";
import { s as C } from "./step.sPVUIIxm.js";
import "./edges-80f1ebb6.pwPx2d-7.js";
import "./createText-aebacdfe.4tdR55WE.js";
import "./line.3WL5MWbk.js";
import "./array.R1yjboNr.js";
import "./path.W_6FqIEh.js";
import "../locales/en.js";
const S = (s) => _.sanitizeText(s, c());
let k = {
  dividerMargin: 10,
  padding: 5,
  textHeight: 10,
...
const P = function(s, t, y, n) {
  ...
  s.forEach(function(e) {
    ...
    e.text = e.title, e.text === void 0 ? e.style !== void 0 && (o.arrowheadStyle = "fill: #333") : (o.arrowheadStyle = "fill: #333", o.labelpos = "c", ((i = c().flowchart) == null ? void 0 : i.htmlLabels) ?? c().htmlLabels ? (o.labelType = "html", o.label = '<span class="edgeLabel">' + e.text + "</span>") : (o.labelType = "text", o.label = e.text.replace(_.lineBreakRegex, `
