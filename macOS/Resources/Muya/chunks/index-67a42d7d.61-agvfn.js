import { b as G, i as m, m as O, G as j, l as A } from "./layout.JVnYm5l-.js";
import { i as M, u as _, s as H, a as V, b as U, p as D, c as W, d as Y, e as q, f as z, g as L, h as C } from "./edges-80f1ebb6.pwPx2d-7.js";
import { l as i, p as N, c as S, h as T } from "./mermaid.core.ZiMYvjlI.js";
import { c as K } from "./createText-aebacdfe.4tdR55WE.js";
var Q = 4;
function Z(e) {
  return G(e, Q);
}
function x(e) {
  ...
  return m(e.graph()) || (t.value = Z(e.graph())), t;
}
function I(e) {
...
const et = () => {
  ...
  e.nodes().forEach(function(n) {
    e.children(n).length > 0 && (i.warn(
      ...
      b(n, e)
    ), g[n] = p(n, e), f[n] = { id: b(n, e), clusterData: e.node(n) });
  }), e.nodes().forEach(function(n) {
  ...
  return t.width = v.width, t.height = v.height, t.intersect = function(a) {
    return C(t, a);
  }, n;
}, at = (e, t) => {
  ...
  const v = r.node().getBBox();
  return t.height = v.height, t.intersect = function(a) {
    return C(t, a);
  }, n;
}, ot = (e, t) => {
...
const ft = (e, t) => {
  ...
  await Promise.all(
    t.nodes().map(async function(a) {
      ...
      if (i.info("(Insert) Node XXX" + a + ": " + JSON.stringify(t.node(a))), o && o.clusterNode) {
        ...
        const y = await $(w, o.graph, n, r, t.node(a)), B = y.elem;
        _(o, B), o.diff = y.diff || 0, i.info("Node bounds (abc123)", a, o, o.width, o.x, o.y), H(B, o), i.warn("Recursive render complete ", B, o);
      } else
        t.children(a).length > 0 ? (i.info("Cluster - the non recursive path XXX", a, o.id, o, t), i.info(b(o.id, t)), f[o.id] = { id: b(o.id, t), node: o }) : (i.info("Node - the non recursive path", a, o.id, o), await V(w, t.node(a), c));
    })
  ), t.edges().forEach(function(a) {
    const o = t.edge(a.v, a.w, a.name);
    i.info("Edge " + a.v + " -> " + a.w + ": " + JSON.stringify(a)), i.info("Edge " + a.v + " -> " + a.w + ": ", a, " ", JSON.stringify(t.edge(a))), i.info("Fix", f, "ids:", a.v, a.w, "Translateing: ", f[a.v], f[a.w]), U(h, o);
  }), t.edges().forEach(function(a) {
    i.info("Edge " + a.v + " -> " + a.w + ": " + JSON.stringify(a));
  }), i.info("#############################################"), i.info("###                Layout                 ###"), i.info("#############################################"), i.info(t), A(t), i.info("Graph after layout:", x(t));
  let v = 0;
  return st(t).forEach(function(a) {
    ...
    const y = W(u, a, o, f, n, t, r);
    Y(o, y);
  }), t.nodes().forEach(function(a) {
    const o = t.node(a);
    i.info(a, o.type, o.diff), o.type === "group" && (v = o.diff);
  }), { elem: d, diff: v };
}, xt = async (e, t, n, r, s) => {
  M(e, n, r, s), q(), z(), dt(), et(), i.warn("Graph at first:", JSON.stringify(x(t))), it(t), i.warn("Graph after:", JSON.stringify(x(t))), await $(e, t, r, s);
};
export {
  xt as r
};
