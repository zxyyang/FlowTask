(function(i) {
  var o = /\((?:[^()]|\((?:[^()]|\([^()]*\))*\))*\)/.source, n = /(?:\b\w+(?:<braces>)?|<braces>)/.source.replace(/<braces>/g, function() {
    return o;
  }), t = i.languages.pascaligo = {
    comment: /\(\*[\s\S]+?\*\)|\/\/.*/,
    string: {
    ...
    punctuation: /\(\.|\.\)|[()\[\]:;,.{}]/
  }, a = ["comment", "keyword", "builtin", "operator", "punctuation"].reduce(function(e, r) {
    return e[r] = t[r], e;
  }, {});
