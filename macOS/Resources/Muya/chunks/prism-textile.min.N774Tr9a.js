(function(r) {
  function n(l, s) {
    return RegExp(l.replace(/<MOD>/g, function() {
      return `(?:\\([^|()
]+\\)|\\[[^\\]
]+\\]|\\{[^}
]+\\})`;
