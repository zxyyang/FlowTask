import { G as V } from "./layout.JVnYm5l-.js";
import { af as D, ag as M, ah as R, ai as j, aj as F, ak as U, ac as H, o as N, l as y, p as W, c as C, j as G, q as $, h as _, x as X, r as J, al as K } from "./mermaid.core.ZiMYvjlI.js";
import { r as Q } from "./index-67a42d7d.61-agvfn.js";
import { s as E } from "./step.sPVUIIxm.js";
function Y(e) {
  return typeof e == "string" ? new D([document.querySelectorAll(e)], [document.documentElement]) : new D([R(e)], M);
}
const Z = (e, l) => j.lang.round(F.parse(e)[l]), O = Z;
function fe(e, l) {
...
const z = {}, le = function(e) {
  ...
  e.forEach(function(n) {
    ...
    i[p] === void 0 ? (i[p] = 0, y.info("abc78 new entry", p, i[p])) : (i[p]++, y.info("abc78 new entry", p, i[p]));
    let r = p + "-" + i[p];
    y.info("abc78 new link id to be used is", p, r, i[p]);
    const g = "LS-" + n.start, w = "LE-" + n.end, t = { style: "", labelStyle: "" };
...
`), n.style === void 0 && (t.style = t.style || "stroke: #333; stroke-width: 1.5px;fill:none;"), t.labelStyle = t.labelStyle.replace("color:", "fill:"), t.id = r, t.classes = "flowchart-link " + g + " " + w, l.setEdge(n.start, n.end, t, a);
  });
}, ae = function(e, l) {
  ...
  i === void 0 && (i = "TD");
  const { securityLevel: d, flowchart: u } = C(), n = u.nodeSpacing || 50, p = u.rankSpacing || 50;
  let r;
  d === "sandbox" && (r = _("#i" + l));
  ...
  for (let f = b.length - 1; f >= 0; f--)
    s = b[f], y.info("Subgraph - ", s), a.db.addVertex(
      s.id,
  ...
  const o = a.db.getVertices(), m = a.db.getEdges();
  y.info("Edges", m);
  let k = 0;
  for (k = b.length - 1; k >= 0; k--) {
    s = b[k], Y("cluster").append("text");
    for (let f = 0; f < s.nodes.length; f++)
      y.info("Setting up subgraphs", s.nodes[f], s.id), t.setParent(s.nodes[f], s.id);
  }
  q(o, t, l, g, w, a), P(m, t);
  const T = g.select(`[id="${l}"]`), v = g.select("#" + l + " g");
  if (await Q(v, t, ["point", "circle", "cross"], "flowchart", l), X.insertTitle(T, "flowchartTitleText", u.titleTopMargin, a.db.getDiagramTitle()), J(t, T, u.diagramPadding, u.useMaxWidth), a.db.indexNodes("subGraph" + k), !u.htmlLabels) {
