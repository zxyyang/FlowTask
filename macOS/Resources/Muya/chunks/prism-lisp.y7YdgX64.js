(function(t) {
  ...
  var e = /(?!\d)[-+*/~!@$%^=<>{}\w]+/.source, c = "&" + e, a = "(\\()", g = "(?=\\))", d = "(?=\\s)", n = /(?:[^()]|\((?:[^()]|\((?:[^()]|\((?:[^()]|\((?:[^()]|\([^()]*\))*\))*\))*\))*\))*/.source, r = {
    ...
    keyword: [
      {
        pattern: RegExp(
          a + "(?:and|(?:cl-)?letf|cl-loop|cond|cons|error|if|(?:lexical-)?let\\*?|message|not|null|or|provide|require|setq|unless|use-package|when|while)" + d
        ),
        lookbehind: !0
      },
      {
        pattern: RegExp(
          a + "(?:append|by|collect|concat|do|finally|for|in|return)" + d
        ),
        lookbehind: !0
      }
    ],
    declare: {
      pattern: u(/declare/.source),
      lookbehind: !0,
      alias: "keyword"
    },
    interactive: {
      pattern: u(/interactive/.source),
      lookbehind: !0,
      alias: "keyword"
    },
    boolean: {
      pattern: p(/nil|t/.source),
      lookbehind: !0
    },
    number: {
      pattern: p(/[-+]?\d+(?:\.\d*)?/.source),
      lookbehind: !0
    },
    defvar: {
    ...
    defun: {
      pattern: RegExp(a + /(?:cl-)?(?:defmacro|defun\*?)\s+/.source + e + /\s+\(/.source + n + /\)/.source),
      lookbehind: !0,
      greedy: !0,
      inside: {
        keyword: /^(?:cl-)?def\S+/,
    ...
    varform: {
      pattern: RegExp(/\(/.source + e + /\s+(?=\S)/.source + n + /\)/.source),
      inside: r
    },
    argument: {
