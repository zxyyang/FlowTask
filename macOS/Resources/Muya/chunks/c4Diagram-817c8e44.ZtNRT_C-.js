import { s as Ce, g as we, a as Oe, b as Te, c as Dt, d as ue, e as Re, f as wt, h as Nt, l as le, i as De, w as Se, j as Kt, k as oe, m as Pe } from "./mermaid.core.ZiMYvjlI.js";
import { d as Me, g as Le } from "./svgDrawCommon-ad5ef572.ywWvsPnr.js";
  ...
  var e = function(bt, _, x, m) {
    ...
    parse: function(_) {
      ...
      for (var M, kt, N, qt, Ct = {}, Mt, z, re, Lt; ; ) {
        if (kt = m[m.length - 1], this.defaultActions[kt] ? N = this.defaultActions[kt] : ((M === null || typeof M > "u") && (M = Ae()), N = Tt[kt] && Tt[kt][M]), typeof N > "u" || !N.length || !N[0]) {
          var Gt = "";
          Lt = [];
          for (Mt in Tt[kt])
