import { z as H, A as fr, S as O, B as x, C as F, D as fn, E as dr, F as cr, G as hr, H as Te, I as lr, J as vr, K as dn, L as X, M as gr, N as Le, O as pr, P as q, Q as an, R as Cn, T as br, U as Ln, V as wr, W as mr, X as U, Y as In, Z as _r, _ as Ae, $ as Kn, a0 as Er, a1 as yr, a2 as Ne, a3 as V, a4 as Oe, a5 as xr, a6 as Pn, a7 as on, a8 as Tr, a9 as bn, aa as Lr, ab as B, ac as Xn, ad as Vn, ae as An } from "./mermaid.core.ZiMYvjlI.js";
var Ar = "[object Symbol]";
function $(n) {
  return typeof n == "symbol" || H(n) && fr(n) == Ar;
}
function R(n, e) {
...
var Qn = NaN, $r = /^[-+]0x[0-9a-f]+$/i, Sr = /^0b[01]+$/i, Mr = /^0o[0-7]+$/i, Rr = parseInt;
function Fr(n) {
  if (typeof n == "number")
    return n;
  if ($(n))
...
function $n(n, e) {
  if (x(n))
    return !1;
  var r = typeof n;
  return r == "number" || r == "symbol" || r == "boolean" || n == null || $(n) ? !0 : Wr.test(n) || !qr.test(n) || e != null && n in Object(e);
}
var jr = 500;
function Kr(n) {
  var e = hr(n, function(t) {
    return r.size === jr && r.clear(), t;
  }), r = e.cache;
  return e;
}
...
var ae = an && an.isSet, jt = ae ? Cn(ae) : Wt;
const Kt = jt;
var Xt = 1, Vt = 2, Zt = 4, De = "[object Arguments]", Jt = "[object Array]", Qt = "[object Boolean]", zt = "[object Date]", ni = "[object Error]", Ge = "[object Function]", ei = "[object GeneratorFunction]", ri = "[object Map]", ti = "[object Number]", ke = "[object Object]", ii = "[object RegExp]", ai = "[object Set]", oi = "[object String]", si = "[object Symbol]", ui = "[object WeakMap]", fi = "[object ArrayBuffer]", di = "[object DataView]", ci = "[object Float32Array]", hi = "[object Float64Array]", li = "[object Int8Array]", vi = "[object Int16Array]", gi = "[object Int32Array]", pi = "[object Uint8Array]", bi = "[object Uint8ClampedArray]", wi = "[object Uint16Array]", mi = "[object Uint32Array]", w = {};
w[De] = w[Jt] = w[fi] = w[di] = w[Qt] = w[zt] = w[ci] = w[hi] = w[li] = w[vi] = w[gi] = w[ri] = w[ti] = w[ke] = w[ii] = w[ai] = w[oi] = w[si] = w[pi] = w[bi] = w[wi] = w[mi] = !0;
w[ni] = w[Ge] = w[ui] = !1;
...
function Ye(n, e, r, t, i, a) {
  ...
  if (f && d)
    return f == e && d == n;
  var h = -1, l = !0, g = r & Oi ? new W() : void 0;
...
var Ii = 1, Pi = 2, $i = "[object Boolean]", Si = "[object Date]", Mi = "[object Error]", Ri = "[object Map]", Fi = "[object Number]", Di = "[object RegExp]", Gi = "[object Set]", ki = "[object String]", Bi = "[object Symbol]", Yi = "[object ArrayBuffer]", Ui = "[object DataView]", oe = O ? O.prototype : void 0, wn = oe ? oe.valueOf : void 0;
function Hi(n, e, r, t, i, a, o) {
  switch (r) {
    case Ui:
...
var qi = 1, Wi = Object.prototype, ji = Wi.hasOwnProperty;
function Ki(n, e, r, t, i, a) {
  var o = r & qi, s = Nn(n), u = s.length, f = Nn(e), d = f.length;
  if (u != d && !o)
    return !1;
  for (var h = u; h--; ) {
    var l = s[h];
    if (!(o ? l in e : ji.call(e, l)))
      return !1;
  }
  ...
  for (var m = o; ++h < u; ) {
    ...
    var _ = n[l], I = e[l];
    if (t)
      var jn = o ? t(I, _, l, e, n, a) : t(_, I, l, n, e, a);
    if (!(jn === void 0 ? _ === I || i(_, I, r, t, a) : jn)) {
      p = !1;
      break;
    }
    m || (m = l == "constructor");
...
function Zi(n, e, r, t, i, a) {
  var o = x(n), s = x(e), u = o ? ue : q(n), f = s ? ue : q(e);
  ...
  if (l && !d)
    return a || (a = new U()), o || Er(n) ? Ye(n, e, r, t, i, a) : Hi(n, e, u, r, t, i, a);
  if (!(r & Xi)) {
...
function Fn(n, e, r, t, i) {
  return n === e ? !0 : n == null || e == null || !H(n) && !H(e) ? n !== n && e !== e : Zi(n, e, r, t, Fn, i);
}
var Ji = 1, Qi = 2;
function zi(n, e, r, t) {
...
function We(n, e) {
  return n != null && qe(n, e, ra);
}
var ta = 1, ia = 2;
function aa(n, e) {
  return $n(n) && Ue(e) ? He(Z(n), e) : function(r) {
    var t = zr(r, n);
    return t === void 0 && t === e ? We(r, n) : Fn(e, t, ta | ia);
  };
}
function oa(n) {
  return function(e) {
...
const de = ca;
var je = Object.prototype, ha = je.hasOwnProperty, la = Pn(function(n, e) {
  n = Object(n);
  var r = -1, t = e.length, i = t > 2 ? e[2] : void 0;
  for (i && on(e[0], e[1], i) && (t = 1); ++r < t; )
    for (var a = e[r], o = X(a), s = -1, u = o.length; ++s < u; ) {
      var f = o[s], d = n[f];
      (d === void 0 || Ae(d, je[f]) && !ha.call(n, f)) && (n[f] = a[f]);
    }
  return n;
});
const va = la;
...
function ka(n) {
  return function(e, r, t) {
    return t && typeof t != "number" && on(e, r, t) && (r = t = void 0), e = rn(e), r === void 0 ? (r = e, e = 0) : r = rn(r), t = t === void 0 ? e < r ? 1 : -1 : rn(t), Ga(e, r, t, n);
  };
}
var Ba = ka();
const D = Ba;
...
const Q = Ua;
var Ha = 1 / 0, qa = bn && 1 / Rn(new bn([, -0]))[1] == Ha ? function(n) {
  return new bn(n);
} : kr;
const Wa = qa;
var ja = 200;
function Ka(n, e, r) {
  var t = -1, i = Hr, a = n.length, o = !0, s = [], u = s;
  if (r)
    o = !1, i = ga;
  else if (a >= ja) {
    var f = e ? null : Wa(n);
...
function be(n, e, r, t, i, a) {
  var o = { width: 0, height: 0, rank: a, borderType: e }, s = i[e][a - 1], u = k(n, "border", o, r);
  ...
  if (a !== t + 1) {
    ...
    for (h = 0, ++t; t < a; ++h, ++t)
      s.points = [], d = {
        ...
        edgeObj: e,
        rank: t
      }, f = k(n, "edge", d, "_d"), t === u && (d.width = s.width, d.height = s.height, d.dummy = "edge-label", d.labelpos = s.labelpos), n.setEdge(r, f, { weight: s.weight }, o), h === 0 && n.graph().dummyChains.push(f), r = f;
...
function ar(n, e, r, t) {
  var i = r.v, a = r.w;
  n.removeEdge(i, a), n.setEdge(t.v, t.w, {}), Wn(n), qn(n, e), $o(n, e);
}
function $o(n, e) {
  var r = kn(n.nodes(), function(i) {
...
function Do(n) {
  var e = k(n, "root", {}, "_root"), r = Go(n), t = S(N(r)) - 1, i = 2 * t + 1;
...
function Uo(n, e, r) {
  var t = Ho(n), i = new L({ compound: !0 }).setGraph({ root: t }).setDefaultNodeLabel(function(a) {
    return n.node(a);
  });
...
function sr(n, e, r, t) {
  ...
  zo(d, u);
  var h = Jo(d, t);
  if (o && (h.vs = G([o, h.vs, s]), n.predecessors(o).length)) {
...
function es(n) {
  var e = Ze(n), r = ye(n, D(1, e + 1), "inEdges"), t = ye(n, D(e - 1, -1, -1), "outEdges"), i = jo(n);
  xe(n, i);
...
function us(n, e) {
  if (n.node(e).dummy)
    return kn(n.predecessors(e), function(r) {
...
function vs(n, e) {
  var r = N(e), t = j(r), i = S(r);
  c(["u", "d"], function(a) {
    c(["l", "r"], function(o) {
      var s = a + o, u = n[s], f;
      if (u !== e) {
        var d = N(u);
        f = o === "l" ? t - j(d) : i - S(d), f && (n[s] = gn(u, function(h) {
          return h + f;
        }));
      }
    });
