import { c as Te, s as Ce, g as Fe, b as Me, a as De, l as Ne, y as Pe, h as oe, i as Ye, j as ke } from "./mermaid.core.ZiMYvjlI.js";
import { G as Ue, l as Be } from "./layout.JVnYm5l-.js";
import "./emojis.bYhmvyOg.js";
import { l as Qe } from "./line.3WL5MWbk.js";
import "./step.sPVUIIxm.js";
import "../locales/en.js";
import "./array.R1yjboNr.js";
import "./path.W_6FqIEh.js";
var ce = function() {
  var e = function(V, i, n, a) {
    for (n = n || {}, a = V.length; a--; n[V[a]] = i)
      ;
    return n;
  }, t = [1, 3], l = [1, 4], c = [1, 5], u = [1, 6], d = [5, 6, 8, 9, 11, 13, 31, 32, 33, 34, 35, 36, 44, 62, 63], p = [1, 18], h = [2, 7], o = [1, 22], g = [1, 23], R = [1, 24], A = [1, 25], T = [1, 26], N = [1, 27], v = [1, 20], k = [1, 28], x = [1, 29], F = [62, 63], de = [5, 8, 9, 11, 13, 31, 32, 33, 34, 35, 36, 44, 51, 53, 62, 63], pe = [1, 47], ye = [1, 48], fe = [1, 49], _e = [1, 50], ge = [1, 51], Ee = [1, 52], Re = [1, 53], O = [53, 54], M = [1, 64], D = [1, 60], P = [1, 61], Y = [1, 62], U = [1, 63], B = [1, 65], j = [1, 69], z = [1, 70], X = [1, 67], J = [1, 68], m = [5, 8, 9, 11, 13, 31, 32, 33, 34, 35, 36, 44, 62, 63], ie = {
    trace: function() {
    },
    yy: {},
    ...
    performAction: function(i, n, a, r, y, s, W) {
      var _ = s.length - 1;
      switch (y) {
        case 4:
        ...
        case 7:
          ...
          break;
        case 13:
          r.addRequirement(s[_ - 3], s[_ - 4]);
          break;
        case 14:
          r.setNewReqId(s[_ - 2]);
          break;
        case 15:
          r.setNewReqText(s[_ - 2]);
          break;
        case 16:
          r.setNewReqRisk(s[_ - 2]);
          break;
        case 17:
          r.setNewReqVerifyMethod(s[_ - 2]);
          break;
        case 20:
        ...
        case 33:
          ...
          break;
        case 34:
          r.setNewElementType(s[_ - 2]);
          break;
        case 35:
          r.setNewElementDocRef(s[_ - 2]);
          break;
        case 38:
          r.addRelationship(s[_ - 2], s[_], s[_ - 4]);
          break;
        case 39:
          r.addRelationship(s[_ - 2], s[_ - 4], s[_]);
          break;
        case 40:
    ...
    parse: function(i) {
      var n = this, a = [0], r = [], y = [null], s = [], W = this.table, _ = "", Z = 0, me = 0, Ve = 2, Ie = 1, qe = s.slice.call(arguments, 1), E = Object.create(this.lexer), L = { yy: {} };
      for (var ne in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, ne) && (L.yy[ne] = this.yy[ne]);
      E.setInput(i, L.yy), L.yy.lexer = E, L.yy.parser = this, typeof E.yylloc > "u" && (E.yylloc = {});
      var se = E.yylloc;
      s.push(se);
      var Oe = E.options && E.options.ranges;
      typeof L.yy.parseError == "function" ? this.parseError = L.yy.parseError : this.parseError = Object.getPrototypeOf(this).parseError;
      function Le() {
        var $;
        return $ = r.pop() || E.lex() || Ie, typeof $ != "number" && ($ instanceof Array && (r = $, $ = r.pop()), $ = n.symbols_[$] || $), $;
      }
      for (var I, C, S, ae, Q = {}, ee, w, be, te; ; ) {
        if (C = a[a.length - 1], this.defaultActions[C] ? S = this.defaultActions[C] : ((I === null || typeof I > "u") && (I = Le()), S = W[C] && W[C][I]), typeof S > "u" || !S.length || !S[0]) {
          ...
          E.showPosition ? le = "Parse error on line " + (Z + 1) + `:
` + E.showPosition() + `
Expecting ` + te.join(", ") + ", got '" + (this.terminals_[I] || I) + "'" : le = "Parse error on line " + (Z + 1) + ": Unexpected " + (I == Ie ? "end of input" : "'" + (this.terminals_[I] || I) + "'"), this.parseError(le, {
        ...
        switch (S[0]) {
          case 1:
            a.push(I), y.push(E.yytext), s.push(E.yylloc), a.push(S[1]), I = null, me = E.yyleng, _ = E.yytext, Z = E.yylineno, se = E.yylloc;
            break;
          case 2:
            if (w = this.productions_[S[1]][1], Q.$ = y[y.length - w], Q._$ = {
              ...
              return ae;
            w && (a = a.slice(0, -1 * w * 2), y = y.slice(0, -1 * w), s = s.slice(0, -1 * w)), a.push(this.productions_[S[1]][0]), y.push(Q.$), s.push(Q._$), be = W[a[a.length - 2]][a[a.length - 1]], a.push(be);
            break;
          case 3:
            return !0;
        }
    ...
    var V = {
      ...
      unput: function(i) {
        ...
        return this.yylloc = {
          ...
          last_column: a ? (a.length === r.length ? this.yylloc.first_column : 0) + r[r.length - a.length].length - a[0].length : this.yylloc.first_column - n
        }, this.options.ranges && (this.yylloc.range = [y[0], y[0] + this.yyleng - n]), this.yyleng = this.yytext.length, this;
      },
...
` + n + "^";
      ...
      test_match: function(i, n) {
        ...
        }, this.options.ranges && (y.yylloc.range = this.yylloc.range.slice(0))), r = i[0].match(/(?:\r\n?|\n).*/g), r && (this.yylineno += r.length), this.yylloc = {
          first_line: this.yylloc.last_line,
          last_line: this.yylineno + 1,
          first_column: this.yylloc.last_column,
          last_column: r ? r[r.length - 1].length - r[r.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + i[0].length
        }, this.yytext += i[0], this.match += i[0], this.matches = i, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(i[0].length), this.matched += i[0], a = this.performAction.call(this, this.yy, this, n, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), a)
          return a;
        if (this._backtrack) {
          for (var s in y)
            this[s] = y[s];
      ...
      next: function() {
        ...
        for (var y = this._currentRules(), s = 0; s < y.length; s++)
          if (a = this._input.match(this.rules[y[s]]), a && (!n || a[0].length > n[0].length)) {
            if (n = a, r = s, this.options.backtrack_lexer) {
              if (i = this.test_match(a, y[s]), i !== !1)
                return i;
              if (this._backtrack) {
                n = !1;
                continue;
        ...
        return n ? (i = this.test_match(n, y[r]), i !== !1 ? i : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      performAction: function(n, a, r, y) {
        switch (r) {
          case 0:
            return "title";
          case 1:
  ...
  return re.prototype = ie, ie.Parser = re, new re();
}();
ce.parser = ce;
const He = ce;
let ue = [], b = {}, K = {}, q = {}, G = {};
const We = {
  ...
  type: q.type,
  docRef: q.docRef
}, Ne.info("Added new requirement: ", e)), q = {}, G[e]), rt = () => G, nt = (e) => {
  q !== void 0 && (q.type = e);
}, st = (e) => {
  q !== void 0 && (q.docRef = e);
}, at = (e, t, l) => {
...
let f = {}, Se = 0;
const Ae = (e, t) => e.insert("rect", "#" + t).attr("class", "req reqBox").attr("x", 0).attr("y", 0).attr("width", f.rect_min_width + "px").attr("height", f.rect_min_height + "px"), ve = (e, t, l) => {
  let c = f.rect_min_width / 2, u = e.append("text").attr("class", "req reqLabel reqTitle").attr("id", t).attr("x", c).attr("y", f.rect_padding).attr("dominant-baseline", "hanging"), d = 0;
  l.forEach((g) => {
    d == 0 ? u.append("tspan").attr("text-anchor", "middle").attr("x", f.rect_min_width / 2).attr("dy", 0).text(g) : u.append("tspan").attr("text-anchor", "middle").attr("x", f.rect_min_width / 2).attr("dy", f.line_height * 0.75).text(g), d++;
  });
  let p = 1.5 * f.rect_padding, h = d * f.line_height * 0.75, o = p + h;
  return e.append("line").attr("class", "req-title-line").attr("x1", "0").attr("x2", f.rect_min_width).attr("y1", o).attr("y2", o), {
    titleNode: u,
    y: o
  };
}, we = (e, t, l, c) => {
  let u = e.append("text").attr("class", "req reqLabel").attr("id", t).attr("x", f.rect_padding).attr("y", c).attr("dominant-baseline", "hanging"), d = 0;
  const p = 30;
  let h = [];
  return l.forEach((o) => {
    let g = o.length;
    for (; g > p && d < 3; ) {
      ...
      o = o.substring(p, o.length), g = o.length, h[h.length] = R, d++;
    }
    if (d == 3) {
      let R = h[h.length - 1];
    ...
    u.append("tspan").attr("x", f.rect_padding).attr("dy", f.line_height).text(o);
  }), u;
}, pt = (e, t, l, c) => {
  ...
  t.type == u.db.Relationships.CONTAINS ? h.attr(
    "marker-start",
    "url(" + ke.getUrl(f.arrowMarkerAbsolute) + "#" + t.type + "_line_ending)"
  ) : (h.attr("stroke-dasharray", "10,7"), h.attr(
    "marker-end",
    "url(" + ke.getUrl(f.arrowMarkerAbsolute) + "#" + xe.ReqMarkers.ARROW + "_line_ending)"
  )), pt(e, h, f, `<<${t.type}>>`);
}, ft = (e, t, l) => {
  ...
  f = Te().requirement;
  const u = f.securityLevel;
  let d;
  u === "sandbox" && (d = oe("#i" + t));
  const h = (u === "sandbox" ? oe(d.nodes()[0].contentDocument.body) : oe("body")).select(`[id='${t}']`);
  xe.insertLineEndings(h, f);
  const o = new Ue({
    multigraph: !1,
    compound: !1,
    directed: !0
  }).setGraph({
    rankdir: f.layoutDirection,
    marginx: 20,
    marginy: 20,
    nodesep: 100,
    edgesep: 100,
  ...
  let g = c.db.getRequirements(), R = c.db.getElements(), A = c.db.getRelationships();
  ft(g, o, h), _t(R, o, h), gt(A, o), Be(o), Et(h, o), A.forEach(function(x) {
    yt(h, x, o, t, c);
  });
  const T = f.rect_padding, N = h.node().getBBox(), v = N.width + T * 2, k = N.height + T * 2;
  Ye(h, k, v, f.useMaxWidth), h.attr("viewBox", `${N.x - T} ${N.y - T} ${v} ${k}`);
}, mt = {
  draw: Rt
}, vt = {
  parser: He,
