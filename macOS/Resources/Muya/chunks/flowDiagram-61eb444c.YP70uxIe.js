import { p as St, f as W } from "./flowDb-170db09d.t-vUrnBt.js";
import { h as S, u as Lt, r as Et, p as _t, l as Tt, d as M, f as tt, G as Nt } from "./layout.JVnYm5l-.js";
import { h as x, o as z, p as et, c as J, j as rt, l as R, q as V, r as At } from "./mermaid.core.ZiMYvjlI.js";
import { a as N, b as at, i as nt, c as _, e as st, d as it, f as Ct, g as It, s as Bt } from "./styles-b966c4ae.plOMGCjG.js";
import { l as Mt } from "./line.3WL5MWbk.js";
import { s as P } from "./step.sPVUIIxm.js";
import "./emojis.bYhmvyOg.js";
import "./index-67a42d7d.61-agvfn.js";
...
`), i.style === void 0 && (l.style = l.style || "stroke: #333; stroke-width: 1.5px;fill:none"), l.labelStyle = l.labelStyle.replace("color:", "fill:"))), l.id = o, l.class = c + " " + d, l.minlen = i.length || 1, e.setEdge(t.db.lookUpDomId(i.start), t.db.lookUpDomId(i.end), l, n);
  ...
  At(h, I, s.diagramPadding, s.useMaxWidth), Object.keys(g).forEach(function(m) {
    const b = g[m];
    if (b.link) {
