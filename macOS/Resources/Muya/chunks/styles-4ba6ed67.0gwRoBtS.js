import { s as Xe, g as We, a as qe, b as He, c as F, u as Je, v as Ze, j as v, y as $e, l as et, x as Pe, h as U, d as tt, ap as ye } from "./mermaid.core.ZiMYvjlI.js";
var De = function() {
  var e = function(L, u, a, o) {
    for (a = a || {}, o = L.length; o--; a[L[o]] = u)
      ;
    return a;
  }, n = [1, 16], r = [1, 17], h = [1, 18], l = [1, 37], A = [1, 38], g = [1, 24], D = [1, 22], B = [1, 23], _ = [1, 29], ne = [1, 30], ue = [1, 31], re = [1, 32], ae = [1, 33], le = [1, 34], ce = [1, 25], oe = [1, 26], he = [1, 27], Ae = [1, 28], d = [1, 42], E = [1, 39], C = [1, 40], m = [1, 41], k = [1, 43], pe = [1, 9], c = [1, 8, 9], Y = [1, 54], K = [1, 55], j = [1, 56], Q = [1, 57], X = [1, 58], fe = [1, 59], de = [1, 60], W = [1, 8, 9, 38], Ne = [1, 71], V = [1, 8, 9, 12, 13, 21, 36, 38, 41, 58, 59, 60, 61, 62, 63, 64, 69, 71], q = [1, 8, 9, 12, 13, 19, 21, 36, 38, 41, 45, 58, 59, 60, 61, 62, 63, 64, 69, 71, 84, 86, 87, 88, 89], H = [13, 84, 86, 87, 88, 89], M = [13, 63, 64, 84, 86, 87, 88, 89], ve = [13, 58, 59, 60, 61, 62, 84, 86, 87, 88, 89], Ee = [1, 90], Ce = [1, 8, 9, 36, 38, 41], J = [1, 8, 9, 21], me = {
    trace: function() {
    },
    yy: {},
    ...
    performAction: function(u, a, o, i, p, t, G) {
      var s = t.length - 1;
      switch (p) {
        case 8:
          this.$ = t[s - 1];
    ...
    parse: function(u) {
      var a = this, o = [0], i = [], p = [null], t = [], G = this.table, s = "", Z = 0, Le = 0, Ye = 2, xe = 1, Ke = t.slice.call(arguments, 1), b = Object.create(this.lexer), I = { yy: {} };
      for (var ge in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, ge) && (I.yy[ge] = this.yy[ge]);
      b.setInput(u, I.yy), I.yy.lexer = b, I.yy.parser = this, typeof b.yylloc > "u" && (b.yylloc = {});
      var ke = b.yylloc;
      t.push(ke);
      var je = b.options && b.options.ranges;
      typeof I.yy.parseError == "function" ? this.parseError = I.yy.parseError : this.parseError = Object.getPrototypeOf(this).parseError;
      function Qe() {
        var N;
        return N = i.pop() || b.lex() || xe, typeof N != "number" && (N instanceof Array && (i = N, N = i.pop()), N = a.symbols_[N] || N), N;
      }
      for (var T, O, y, Te, w = {}, $, S, Ie, ee; ; ) {
        if (O = o[o.length - 1], this.defaultActions[O] ? y = this.defaultActions[O] : ((T === null || typeof T > "u") && (T = Qe()), y = G[O] && G[O][T]), typeof y > "u" || !y.length || !y[0]) {
          var Fe = "";
          ee = [];
          for ($ in G[O])
            this.terminals_[$] && $ > Ye && ee.push("'" + this.terminals_[$] + "'");
          b.showPosition ? Fe = "Parse error on line " + (Z + 1) + `:
` + b.showPosition() + `
Expecting ` + ee.join(", ") + ", got '" + (this.terminals_[T] || T) + "'" : Fe = "Parse error on line " + (Z + 1) + ": Unexpected " + (T == xe ? "end of input" : "'" + (this.terminals_[T] || T) + "'"), this.parseError(Fe, {
            text: b.match,
        ...
        switch (y[0]) {
          case 1:
            o.push(T), p.push(b.yytext), t.push(b.yylloc), o.push(y[1]), T = null, Le = b.yyleng, s = b.yytext, Z = b.yylineno, ke = b.yylloc;
            break;
          case 2:
            if (S = this.productions_[y[1]][1], w.$ = p[p.length - S], w._$ = {
              first_line: t[t.length - (S || 1)].first_line,
              last_line: t[t.length - 1].last_line,
              first_column: t[t.length - (S || 1)].first_column,
              last_column: t[t.length - 1].last_column
            }, je && (w._$.range = [
              t[t.length - (S || 1)].range[0],
              t[t.length - 1].range[1]
            ]), Te = this.performAction.apply(w, [
              s,
              Le,
              Z,
              I.yy,
              ...
              return Te;
            S && (o = o.slice(0, -1 * S * 2), p = p.slice(0, -1 * S), t = t.slice(0, -1 * S)), o.push(this.productions_[y[1]][0]), p.push(w.$), t.push(w._$), Ie = G[o[o.length - 2]][o[o.length - 1]], o.push(Ie);
            break;
          case 3:
            return !0;
        }
    ...
    var L = {
      ...
      unput: function(u) {
        ...
        return this.yylloc = {
          ...
          last_column: o ? (o.length === i.length ? this.yylloc.first_column : 0) + i[i.length - o.length].length - o[0].length : this.yylloc.first_column - a
...
` + a + "^";
      ...
      test_match: function(u, a) {
        ...
        }, this.options.ranges && (p.yylloc.range = this.yylloc.range.slice(0))), i = u[0].match(/(?:\r\n?|\n).*/g), i && (this.yylineno += i.length), this.yylloc = {
          first_line: this.yylloc.last_line,
          last_line: this.yylineno + 1,
          first_column: this.yylloc.last_column,
          last_column: i ? i[i.length - 1].length - i[i.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + u[0].length
        }, this.yytext += u[0], this.match += u[0], this.matches = u, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(u[0].length), this.matched += u[0], o = this.performAction.call(this, this.yy, this, a, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), o)
          return o;
        if (this._backtrack) {
          for (var t in p)
            this[t] = p[t];
      ...
      next: function() {
        ...
        for (var p = this._currentRules(), t = 0; t < p.length; t++)
          if (o = this._input.match(this.rules[p[t]]), o && (!a || o[0].length > a[0].length)) {
            if (a = o, i = t, this.options.backtrack_lexer) {
              if (u = this.test_match(o, p[t]), u !== !1)
                return u;
              if (this._backtrack) {
                a = !1;
                continue;
        ...
        return a ? (u = this.test_match(a, p[i]), u !== !1 ? u : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      options: {},
      performAction: function(a, o, i, p) {
        switch (i) {
          case 0:
            return 52;
          case 1:
  ...
  return be.prototype = me, me.Parser = be, new be();
}();
De.parser = De;
const Nt = De, Oe = ["#", "+", "~", "-", ""];
class Re {
  ...
  getDisplayDetails() {
    let n = this.visibility + ye(this.id);
    this.memberType === "method" && (n += `(${ye(this.parameters.trim())})`, this.returnType && (n += " : " + ye(this.returnType))), n = n.trim();
  ...
  parseMember(n) {
    ...
    if (this.memberType === "method") {
      const h = /([#+~-])?(.+)\((.*)\)([\s$*])?(.*)([$*])?/, l = n.match(h);
      if (l) {
        const A = l[1] ? l[1].trim() : "";
        if (Oe.includes(A) && (this.visibility = A), this.id = l[2].trim(), this.parameters = l[3] ? l[3].trim() : "", r = l[4] ? l[4].trim() : "", this.returnType = l[5] ? l[5].trim() : "", r === "") {
      ...
      const h = n.length, l = n.substring(0, 1), A = n.substring(h - 1);
      Oe.includes(l) && (this.visibility = l), A.match(/[*?]/) && (r = A), this.id = n.substring(
        this.visibility === "" ? 0 : 1,
        r === "" ? h : h - 1
      );
    }
...
const ie = "classId-";
let _e = [], f = {}, te = [], we = 0, x = {}, Be = 0, z = [];
const R = (e) => v.sanitizeText(e, F()), P = function(e) {
  const n = v.sanitizeText(e, F());
  let r = "", h = n;
  if (n.indexOf("~") > 0) {
    const l = n.split("~");
    h = R(l[0]), r = R(l[1]);
  }
  return { className: h, type: r };
}, st = function(e, n) {
  const r = v.sanitizeText(e, F());
  n && (n = R(n));
  const { className: h } = P(r);
  f[h].label = n;
}, se = function(e) {
  const n = v.sanitizeText(e, F()), { className: r, type: h } = P(n);
  if (Object.hasOwn(f, r))
    return;
  const l = v.sanitizeText(r, F());
  f[l] = {
    id: l,
    type: h,
    label: l,
  ...
  if (n in f)
    return f[n].domId;
  throw new Error("Class not found: " + n);
}, it = function() {
  _e = [], f = {}, te = [], z = [], z.push(Ge), x = {}, Be = 0, $e();
}, nt = function(e) {
  return f[e];
}, ut = function() {
  return f;
  ...
  et.debug("Adding relation: " + JSON.stringify(e)), se(e.id1), se(e.id2), e.id1 = P(e.id1).className, e.id2 = P(e.id2).className, e.relationTitle1 = v.sanitizeText(e.relationTitle1.trim(), F()), e.relationTitle2 = v.sanitizeText(e.relationTitle2.trim(), F()), _e.push(e);
}, ct = function(e, n) {
  const r = P(e).className;
  f[r].annotations.push(n);
}, Me = function(e, n) {
  se(e);
  const r = P(e).className, h = f[r];
  if (typeof n == "string") {
    const l = n.trim();
    l.startsWith("<<") && l.endsWith(">>") ? h.annotations.push(R(l.substring(2, l.length - 2))) : l.indexOf(")") > 0 ? h.methods.push(new Re(l, "method")) : l && h.members.push(new Re(l, "attribute"));
  }
}, ot = function(e, n) {
  Array.isArray(n) && (n.reverse(), n.forEach((r) => Me(e, r)));
}, ht = function(e, n) {
  const r = {
    id: `note${te.length}`,
    class: n,
  ...
  e.split(",").forEach(function(r) {
    let h = r;
    r[0].match(/\d/) && (h = ie + h), f[h] !== void 0 && f[h].cssClasses.push(n);
  });
}, pt = function(e, n) {
  e.split(",").forEach(function(r) {
    n !== void 0 && (f[r].tooltip = R(n));
  });
}, ft = function(e, n) {
  return n ? x[n].classes[e].tooltip : f[e].tooltip;
}, dt = function(e, n, r) {
  const h = F();
  e.split(",").forEach(function(l) {
    let A = l;
    l[0].match(/\d/) && (A = ie + A), f[A] !== void 0 && (f[A].link = Pe.formatUrl(n, h), h.securityLevel === "sandbox" ? f[A].linkTarget = "_top" : typeof r == "string" ? f[A].linkTarget = R(r) : f[A].linkTarget = "_blank");
  }), Se(e, "clickable");
}, Et = function(e, n, r) {
  e.split(",").forEach(function(h) {
    Ct(h, n, r), f[h].haveCallback = !0;
  }), Se(e, "clickable");
}, Ct = function(e, n, r) {
  const h = v.sanitizeText(e, F());
  if (F().securityLevel !== "loose" || n === void 0)
    return;
  const A = h;
  if (f[A] !== void 0) {
    const g = Ve(A);
    ...
    D.length === 0 && D.push(g), z.push(function() {
  ...
  let n = U(".mermaidTooltip");
  (n._groups || n)[0][0] === null && (n = U("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0)), U(e).select("svg").selectAll("g.node").on("mouseover", function() {
    const l = U(this);
    if (l.attr("title") === null)
      return;
    const g = this.getBoundingClientRect();
    n.transition().duration(200).style("opacity", ".9"), n.text(l.attr("title")).style("left", window.scrollX + g.left + (g.right - g.left) / 2 + "px").style("top", window.scrollY + g.top - 14 + document.body.scrollTop + "px"), n.html(n.html().replace(/&lt;br\/&gt;/g, "<br/>")), l.classed("hover", !0);
  }).on("mouseout", function() {
    n.transition().duration(500).style("opacity", 0), U(this).classed("hover", !1);
  });
};
z.push(Ge);
let Ue = "TB";
const kt = () => Ue, Tt = (e) => {
  ...
  x[e] !== void 0 && n.map((r) => {
    f[r].parent = e, x[e].classes[r] = f[r];
  });
}, vt = {
  setAccTitle: Xe,
  getAccTitle: We,
  ...
  setClassLabel: st,
  addNamespace: Ft,
  addClassesToNamespace: Bt,
  getNamespace: yt,
  getNamespaces: Dt
}, _t = (e) => `g.classGroup text {
