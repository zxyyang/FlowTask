import { p as A, d as S, s as G } from "./styles-4ba6ed67.0gwRoBtS.js";
import { c as v, l as y, h as B, i as W, x as M, ap as $ } from "./mermaid.core.ZiMYvjlI.js";
import { G as I, l as O } from "./layout.JVnYm5l-.js";
import "./emojis.bYhmvyOg.js";
import { l as P } from "./line.3WL5MWbk.js";
import { g as X } from "./step.sPVUIIxm.js";
...
const Y = function(i, a, t, o, p) {
  ...
  const s = a.points, c = P().x(function(e) {
    ...
    return e.y;
  }).curve(X), n = i.append("path").attr("d", c(s)).attr("id", "edge" + H).attr("class", "relation");
  let r = "";
